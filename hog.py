...
def is_swap(score0, score1):
    ...
    # BEGIN PROBLEM 4
    if score0==1 or score0==0 or score1==1 or score1==0:
        return False
    else:
        if score0>=score1 and score0%score1==0:
            return True
        elif score1>=score0 and score1%score0==0:
            return True
        else:
            return False
    # END PROBLEM 4
...
def both(f, g):
    ...
    """
    # BEGIN PROBLEM 6
    def callMe(score0,score1):
        return both(f(score0,score1), g(score0,score1))
    return callMe
    # END PROBLEM 6


def announce_highest(who, previous_high_gain=0, previous_score=0):
    ...
    def announce(score0,score1):
        high_gain = previous_high_gain
        if who == 0:
            score = score0
            if score - previous_score > previous_high_gain:
                high_gain = score - previous_score
        if who == 1:
            score = score1
            if score - previous_score > previous_high_gain:
                high_gain = score - previous_score
        if high_gain > previous_high_gain:
            if high_gain == 1:
                print('1 point! That\'s the biggest gain yet for Player', who)
            else:
                print(high_gain, 'points! That\'s the biggest gain yet for Player', who)
        return announce_highest(who, high_gain, score)
    return announce
    # END PROBLEM 7
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    if is_swap (free_bacon(opponent_score)+score, opponent_score)== True:
        if opponent_score+8 > (free_bacon(opponent_score)+score):
            return 0
        else:
            return num_rolls
